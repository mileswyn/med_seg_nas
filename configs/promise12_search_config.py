...
__C.search_params.arch_update_epoch=150
__C.search_params.val_start_epoch=200
...
__C.optim.last_dim=512
__C.optim.weight=AttrDict()
__C.optim.weight.init_lr=0.025
__C.optim.weight.min_lr=0.0001
__C.optim.weight.lr_decay_type='cosine'
__C.optim.weight.momentum=0.9
__C.optim.weight.weight_decay=3.0e-4

__C.optim.arch=AttrDict()
__C.optim.arch.alpha_lr=0.0003
__C.optim.arch.beta_lr=0.0003
__C.optim.arch.weight_decay=0.0005
