...
# [[384, 512], 'conv1_1']"""
__C.net_config='''[[128, 256], 'cweight', ['basic_block', 'basic_block', 'basic_block', 'basic_block'], 4, 2]|
[[256, 512], 'cweight', ['basic_block', 'basic_block', 'basic_block', 'basic_block'], 4, 2]|
[[512, 1024], 'basic_block', ['basic_block'], 1, 2]'''
'''[[128, 256], 'cweight', ['basic_block', 'basic_block'], 2, 2]|
[[256, 496], 'dil_conv_3x3', ['basic_block', 'dil_conv_3x3', 'basic_block', 'dil_conv_3x3'], 4, 2]|
[[496, 1024], 'basic_block', [], 0, 2]'''

__C.train_params=AttrDict()
__C.train_params.epochs=600
...
__C.data.dataset='Promise12' #imagenet
