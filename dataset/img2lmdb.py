...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_path', type=str, default='/hdd1/wyn/MyImagenet/', help='the path of the images')
    parser.add_argument('--list_path', type=str, default='/hdd1/wyn/DenseNAS/outputpath', help='the path of the image list')
    parser.add_argument('--output_path', type=str, default='/hdd1/wyn/DenseNAS/lmdbpath', help='the output path of the lmdb file')
    parser.add_argument('--split', type=str, default='train', help='the split path of the images: train / val')
    args = parser.parse_args()

    image_size = args.image_size if args.image_size else image_size
    image_folder = osp.join(args.image_path, args.split)
    image_folder = osp.join(args.image_path, 'train')
