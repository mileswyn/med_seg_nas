...
if __name__ == '__main__':
    ...
    parser.add_argument('--save', type=str, default='/hdd1/wyn/DenseNAS/latency_list', help='experiment name')
    parser.add_argument('--input_size', type=str, default='[1, 1, 144, 144, 144]', help='data input size')
    parser.add_argument('--meas_times', type=int, default=5000, help='measure times')
    parser.add_argument('--list_name', type=str, default='latencyList_batch_2_abdominal', help='output list name')
    parser.add_argument('--device', type=str, default='gpu', help='output list name')# choices=['gpu', 'cpu'])
