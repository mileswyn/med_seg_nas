...
sys.path.append('.')
from run_apis.optimizer import Optimizer
from run_apis.trainer import SearchTrainer
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/hdd1/wyn/DenseNAS/lmdbpath/', help='location of the data corpus')
    ...
    parser.add_argument('--job_name', type=str, default='search_mb_Imagenet', help='job_name')
    parser.add_argument('-c', '--config', metavar='C', default='/hdd1/wyn/DenseNAS/configs/imagenet_search_cfg_mbv2.yaml', help='The Configuration file')
    ...
    ArchGenerater = importlib.import_module('run_apis.derive_arch_'+config.net_type, __package__).ArchGenerate
